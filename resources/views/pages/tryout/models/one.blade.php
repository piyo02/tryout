...
<div class="page-inner">
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="row">
                <div class="col-6">
                    <div class="card bg-warning text-white px-2 pt-3 pb-2">
                ...
                <div class="col-6">
                    <form action="/tryout/finished" method="post" id="form_finish" class="form_finish">
                        ...
                        <button style="text-align: center; padding-bottom: 7px !important; padding-top: 13px !important;" id="btn_finish" type="submit" class="btn_finish btn btn-warning">
            ...
            <div class="card d-none" id="{{ $answer->question_id }}" value="{{ $answer->question_id }}">
                ...
                <div class="card-body">
                    ...
                    <div class="options">
                        ...
                        <div class="mb-3"><button id="opt_{{$option->id}}" onclick="answer( {{$option->id}}, {{$answer->question_id}}, {{$option->skor}} )" class="mr-2 btn btn-sm btn-primary btn-round btn-border quest_{{$answer->question_id}}">{{ $options[$loop->iteration] }}</button><span>{{ $option->value }}</span></div>
                        @endforeach
                    </div>
                </div>
            </div>
