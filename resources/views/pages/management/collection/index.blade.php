...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <div>
                <h2 class="text-white pb-2 fw-bold">Manajemen Bank Soal</h2>
            </div>
        </div>
    </div>
</div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group form-group-default">
                                                        ...
                                                        <select class="form-control" id="variation_id" name="variation_id">
                                                            ...
                                                            <option value="{{$tryout_model->id}}">{{$tryout_model->value}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                        ...
                        <tbody>
                            @foreach ($collections as $collection)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-default btn-sm ml-auto text-white" href="/management/collection/token?col_id={{$collection->id}}">
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <form action="/management/collection/{{ $collection->id }}" method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            <p class="small text-danger">Menghapus Bank Soal akan menghapus soal dan seluruh hasil kerja Siswa</p>
